...
public class Ghost extends Monster {
    ...
    @Override public boolean isImmuneToFreeze()      { return true; }
    @Override public boolean isImmuneToElectricity() { return true; }
    @Override public boolean isImmuneToFire()        { return true; }
    @Override public boolean isResistantToSprit()    { return false; }

    @Override protected void collideWithPlayer() {}
}
