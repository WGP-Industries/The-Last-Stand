...
// Background class that handles the scrolling background image for the game. It manages two copies of the background image to create a seamless scrolling effect as the player moves left or right.
